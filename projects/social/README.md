...
1. To create 100 users with an average of 10 friends each, how many times would you need to call `add_friendship()`? Why? Bidirectional makes this in half

 from formula >> num_friendships = num_users * avg_friendships // 2
